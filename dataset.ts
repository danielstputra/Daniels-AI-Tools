...
import {
  ...
  checkDatasetThreshold,
} from "./api/lib/hf-publisher";
...
const PII_PATTERNS: Array<{ pattern: RegExp; replacement: string }> = [
  ...
  {
    pattern: /\b(?:[0-9]{4}[-\s]?){3,4}[0-9]{1,4}\b/g,
...
function scrubEntryPII(
  entry: Omit<DatasetEntry, "id" | "timestamp">,
): Omit<DatasetEntry, "id" | "timestamp"> {
  return {
    ...entry,
