...
export const HALL_OF_FAME: HallOfFameCombo[] = [
  // ── 1. GROK 4.20 — Semantic Inversion + ⊰ dividers ─────────────
  {
    ...
    codename: "GROK 4.20",
    description:
      "Semantic inversion with ⊰ dividers + <eos> token — most permissive frontier model",
    color: "#a855f7",
...
[START OUTPUT]`,
  ...
  // ── 4. CLAUDE INVERSION — END/START boundary trick ──────────────
  {
    ...
    description:
      "END/START INPUT boundary + semantic opposite — plays to Claude's instruction following",
    color: "#ec4899",
...
[START OF OUTPUT]`,
  ...
  // ── 5. DANIELS AI FAST — Hermes 4 405B instant stream ────────────────
  {
    id: "hermes-fast",
    model: "nousresearch/hermes-4-405b",
    codename: "DANIELS AI FAST",
    description:
      "Hermes 4 405B — instant token stream, zero refusal checking. Raw speed.",
    color: "#10b981",
    fast: true,
