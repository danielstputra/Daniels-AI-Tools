    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <ToggleSetting
          ...
          warning={
            datasetGenerationEnabled
              ? "ACTIVE: your prompts and responses are being collected and will be published to a public HuggingFace dataset"
              : "When enabled, your full conversation content is collected and published publicly"
          }
        />
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="theme-secondary">
                Your prompts and model responses are being collected and will be
                published to a public HuggingFace dataset. Basic PII patterns
                (emails, phone numbers, SSNs, credit cards) are automatically
                scrubbed, but you should still avoid including personal
                information, real names, addresses, passwords, or anything you
                would not want publicly visible.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-theme-surface border border-theme-primary rounded-xl max-w-lg mx-4 p-6 shadow-2xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold">
                Enable Public Dataset Contribution?
              </h3>
            </div>
            ...
            <div className="space-y-3 text-sm theme-secondary mb-6">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>
                      Your prompts and model responses will be published
                    </strong>{" "}
                    to a public HuggingFace dataset that anyone can download and
                    use.
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>Do NOT include personal information</strong> — real
                    names, email addresses, phone numbers, physical addresses,
                    passwords, financial details, or any data you would not want
                    publicly visible.
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    Basic PII patterns (emails, phones, SSNs, credit cards, IP
                    addresses) are <strong>automatically scrubbed</strong>, but
                    automated scrubbing is not perfect. You are responsible for
                    what you submit.
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    Once data is published to HuggingFace,{" "}
                    <strong>it may be cached, forked, or redistributed</strong>{" "}
                    beyond our control. You can request deletion, but removal is
                    not guaranteed.
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    <strong>open AI safety research</strong> — studying how
                    models respond to steering primitives across providers.
                  </span>
                </li>
              </ul>
            </div>
