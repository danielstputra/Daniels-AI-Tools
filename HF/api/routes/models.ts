...
const G0DM0D3_MODELS: ModelEntry[] = [
  {
    id: "ultraplinian",
    description:
      "ULTRAPLINIAN: Race 12 models in parallel, return the best (fast tier). Alias for ultraplinian-fast.",
    tier: "fast",
  ...
  },
  {
    ...
    tier: "standard",
    model_count:
      ULTRAPLINIAN_MODELS.fast.length + ULTRAPLINIAN_MODELS.standard.length,
  },
  {
